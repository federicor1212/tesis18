    ...
    public function index($id = null) {
      ...
      if ($id == null){
        ...
        $dictado = Dictado::join('materias','dictados.id_materia','=','materias.id')
                 ...
                 ->select('carreras.id as id_carrera','carreras.desc_carr','dictados.id','materias.id AS id_materia','materias.desc_mat','dictados.cuat','dictados.ano','dictados.fecha_inicio','dictados.fecha_fin','dictados.cant_insc_act','dictados.cant_clases','dictados.cant_faltas_max')
                 ->orderBy('carreras.desc_carr','materias.desc_mat','dictados.ano', 'dictados.cuat')
                 ->get();
